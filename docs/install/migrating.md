...
**OpenKrab:** JSON5 (`~/.krabkrab/openclaw.json`)
```json5
{
  agents: {
    defaults: {
...
| OpenKrab | OpenKrab |
|----------|----------|
| `~/.krabkrab/` | `~/.config/krabkrab/` |
| `~/.krabkrab/openclaw.json` | `~/.config/krabkrab/config.toml` |
| `~/.krabkrab/workspace/` | `~/.local/share/krabkrab/workspace/` |
| `~/.krabkrab/sessions/` | `~/.local/share/krabkrab/sessions/` |
| `~/.krabkrab/credentials/` | `~/.local/share/krabkrab/credentials/` |
...
cp ~/.krabkrab/openclaw.json ~/openclaw-backup.json
```

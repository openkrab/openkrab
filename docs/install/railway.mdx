...
Deploy OpenKrab on Railway with a one-click template and finish setup in your browser.
...
<a href="https://railway.com/deploy/krabkrab-railway-template" target="_blank" rel="noreferrer">
  Deploy on Railway
</a>
...
This exports your OpenKrab state + workspace so you can migrate to another host without losing config or memory.

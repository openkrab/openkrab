---
summary: "Overview of OpenKrab onboarding options and flows"
read_when:
...
OpenKrab supports multiple onboarding paths depending on where the Gateway runs
...
Use the OpenKrab app when you want a fully guided setup on macOS. Docs:

...
- Same path: run the app from a fixed location (for OpenKrab, `dist/OpenKrab.app`).
...
Workaround: move files into the OpenKrab workspace (`~/.openclaw/workspace`) if you want to avoid per-folder grants.

---
summary: "macOS IPC architecture for OpenKrab app, gateway node transport, and PeekabooBridge"
read_when:
  - Editing IPC contracts or menu bar app IPC
title: "macOS IPC"
---

# OpenKrab macOS IPC architecture
...
- Host preference order (client-side): Peekaboo.app → Claude.app → OpenKrab.app → local execution.

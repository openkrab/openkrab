...
You can point OpenKrab at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or OpenKrab
...
- [Anthropic provider](/providers/anthropic) - Native OpenKrab integration with Claude setup-token or API keys

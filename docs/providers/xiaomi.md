---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with OpenKrab"
read_when:
  - You want Xiaomi MiMo models in OpenKrab
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). OpenKrab uses

# Contributing to the OpenKrab Threat Model

Thanks for helping make OpenKrab more secure. This threat model is a living document and we welcome contributions from anyone - you don't need to be a security expert.
...
- [OpenKrab Threat Model](./THREAT-MODEL-ATLAS.md)

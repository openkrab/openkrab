...
- `"none"` (default): tools see a sandbox workspace under `~/.openkrab/sandboxes`.
...
Default image: `openkrab-sandbox:bookworm-slim`
...
- Use `openkrab sandbox explain` to inspect effective sandbox mode, tool policy, and fix-it config keys.

...
- Install via CLI: `openkrab plugins install @openkrab/zalouser`
- Or from a source checkout: `openkrab plugins install ./extensions/zalouser`
...
2. Login (QR, on the Gateway machine):
   - `openkrab channels login --channel zalouser`
...
- `openkrab pairing list zalouser`
- `openkrab pairing approve zalouser <code>`

...
3. Run `openkrab onboard` and select BlueBubbles, or configure manually:
...
- Approve via:
  - `openkrab pairing list bluebubbles`
  - `openkrab pairing approve bluebubbles <CODE>`
...
- Pairing codes expire after one hour; use `openkrab pairing list bluebubbles` and `openkrab pairing approve bluebubbles <code>`.

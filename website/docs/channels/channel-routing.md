...
{
  agents: {
    list: [{ id: "support", name: "Support", workspace: "~/.openkrab/workspace-support" }],
  },
  bindings: [
...
Session stores live under the state directory (default `~/.openkrab`):

- `~/.openkrab/agents/<agentId>/sessions/sessions.json`

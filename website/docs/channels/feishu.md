...
2. Run `openkrab logs --follow` and look for `chat_id`
...
2. Run `openkrab logs --follow` and look for `open_id`
...
| Command                    | Description                   |
| -------------------------- | ----------------------------- |
| `openkrab gateway status`  | Show gateway status           |
| `openkrab gateway install` | Install/start gateway service |
| `openkrab gateway stop`    | Stop gateway service          |
| `openkrab gateway restart` | Restart gateway service       |
| `openkrab logs --follow`   | Tail gateway logs             |
...
4. Check logs: `openkrab logs --follow`
...
5. Ensure the gateway is running: `openkrab gateway status`
6. Check logs: `openkrab logs --follow`

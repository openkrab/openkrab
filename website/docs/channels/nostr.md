...
- The onboarding wizard (`openkrab onboard`) and `openkrab channels add` list optional channel plugins.
...
```json
{
  "channels": {
    "nostr": {
      ...
      "profile": {
        "name": "openkrab",
        "displayName": "openkrab",
        "about": "Personal assistant DM bot",
        "picture": "https://example.com/avatar.png",
        "banner": "https://example.com/banner.png",
        "website": "https://example.com",
        "nip05": "openkrab@example.com",
        "lud16": "openkrab@example.com"
      }
    }
  }
}

...
2. On your Nextcloud server, create a bot:
   ...
   ```bash
   ./occ talk:bot:install "openkrab" "<shared-secret>" "<webhook-url>" --feature reaction
   ```
...
- Approve via:
  - `openkrab pairing list nextcloud-talk`
  - `openkrab pairing approve nextcloud-talk <CODE>`

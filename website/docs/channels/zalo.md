...
- Install via CLI: `openkrab plugins install @openkrab/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `openkrab plugins install ./extensions/zalo`
   - From npm (if published): `openkrab plugins install @openkrab/zalo`
...
- Approve via:
  - `openkrab pairing list zalo`
  - `openkrab pairing approve zalo <CODE>`
...
- Example: `openkrab message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `openkrab channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `openkrab logs --follow`

...
- CLI helpers: `openkrab onboard`, `openkrab models list`, `openkrab models set <provider/model>`.
...
- CLI: `openkrab onboard --auth-choice openai-codex` or `openkrab models auth login --provider openai-codex`
...
- CLI: `openkrab onboard --auth-choice opencode-zen`
...
- Antigravity OAuth is shipped as a bundled plugin (`google-antigravity-auth`, disabled by default).
  - Enable: `openkrab plugins enable google-antigravity-auth`
  - Login: `openkrab models auth login --provider google-antigravity --set-default`
- Gemini CLI OAuth is shipped as a bundled plugin (`google-gemini-cli-auth`, disabled by default).
  - Enable: `openkrab plugins enable google-gemini-cli-auth`
  - Login: `openkrab models auth login --provider google-gemini-cli --set-default`
  - Note: you do **not** paste a client id or secret into `openkrab.json`. The CLI login flow stores
...
- CLI: `openkrab onboard --auth-choice zai-api-key`
...
- CLI: `openkrab onboard --auth-choice ai-gateway-api-key`
...
- CLI: `openkrab onboard --auth-choice synthetic-api-key`

...
- **Session store** (chat history + routing state) under `~/.openkrab/agents/<agentId>/sessions`.
...
```json5
{
  agents: {
    list: [
      { id: "alex", workspace: "~/.openkrab/workspace-alex" },
      { id: "mia", workspace: "~/.openkrab/workspace-mia" },
    ],
  },
  bindings: [
    {
...
```json5
{
  agents: {
    list: [
      { id: "main", workspace: "~/.openkrab/workspace-main" },
      { id: "coding", workspace: "~/.openkrab/workspace-coding" },
    ],
  },
  bindings: [
...
```json5
{
  agents: {
    list: [
      { id: "main", workspace: "~/.openkrab/workspace-main" },
      { id: "alerts", workspace: "~/.openkrab/workspace-alerts" },
    ],
  },
  bindings: [
...
```js
{
    ...
    list: [
      {
        ...
        default: true,
        name: "Home",
        workspace: "~/.openkrab/workspace-home",
        agentDir: "~/.openkrab/agents/home/agent",
      },
      {
        id: "work",
        name: "Work",
        workspace: "~/.openkrab/workspace-work",
        agentDir: "~/.openkrab/agents/work/agent",
      },
    ],
  },
  ...
  channels: {
    whatsapp: {
      accounts: {
        personal: {
          // Optional override. Default: ~/.openkrab/credentials/whatsapp/personal
          // authDir: "~/.openkrab/credentials/whatsapp/personal",
        },
        biz: {
          // Optional override. Default: ~/.openkrab/credentials/whatsapp/biz
    ...
    list: [
      {
        id: "chat",
        name: "Everyday",
        workspace: "~/.openkrab/workspace-chat",
        model: "anthropic/claude-sonnet-4-5",
      },
      {
        id: "opus",
        name: "Deep Work",
        workspace: "~/.openkrab/workspace-opus",

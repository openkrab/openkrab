...
# 2. Clone repository
git clone https://github.com/openkrab/openkrab-ansible.git
cd openkrab-ansible
...
# Or run directly (then manually execute /tmp/openkrab-setup.sh after)
...
# Check sandbox image
sudo docker images | grep openkrab-sandbox
...
- [Security Architecture](https://github.com/openkrab/openkrab-ansible/blob/main/docs/security.md)
- [Technical Details](https://github.com/openkrab/openkrab-ansible/blob/main/docs/architecture.md)
- [Troubleshooting Guide](https://github.com/openkrab/openkrab-ansible/blob/main/docs/troubleshooting.md)

...
1. [https://exe.new/openkrab](https://exe.new/openkrab)
...
with `openkrab doctor --generate-gateway-token`). Approve devices with `openkrab devices list` and
`openkrab devices approve <requestId>`. When in doubt, use Shelley from your browser!

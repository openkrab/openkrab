...
Target: Clawd-style workspace (`agents.defaults.workspace`, default `~/.openkrab/workspace`) where “memory” is stored as one Markdown file per day (`memory/YYYY-MM-DD.md`) plus a small set of stable files (e.g. `memory.md`, `SOUL.md`).
...
- You want the agent itself to call the tools:
  - `openkrab memory recall "…" --k 25 --since 30d`

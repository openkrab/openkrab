...
`gateway discover` scans for Gateway beacons (`_openkrab-gw._tcp`).

- Multicast DNS-SD: `local.`
- Unicast DNS-SD (Wide-Area Bonjour): choose a domain (example: `openkrab.internal.`) and set up split DNS + a DNS server; see [/gateway/bonjour](/gateway/bonjour)
